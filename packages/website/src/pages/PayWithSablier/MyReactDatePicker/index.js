...
function isMonthinRange(startDate, endDate, m, day) {
  ...
  if (startDateYear === endDateYear && startDateYear === dayYear) {
    ...
    return (
      (dayYear === startDateYear && (startDateMonth <= m || endDateMonth < m)) ||
...
function isTimeInExcludedRange(time, _ref6) {
...
function getHightLightDaysMap() {
  ...
  var defaultClassName =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "react-datepicker__day--highlighted";
    ...
    _this.renderOptions = function() {
      ...
      var options = _this.state.yearsList.map(function(year) {
        return React.createElement(
          ...
          selectedYear === year
            ? React.createElement("span", { className: "react-datepicker__year-option--selected" }, "\u2713")
            : "",
          year,
        );
      });
      ...
      (_this.renderOptions = function() {
        return _this.props.monthNames.map(function(month, i) {
          return React.createElement(
            ...
            _this.props.month === i
              ? React.createElement("span", { className: "react-datepicker__month-option--selected" }, "\u2713")
              : "",
            month,
          );
        });
    ...
    _this.renderOptions = function() {
      return _this.state.monthYearsList.map(function(monthYear) {
        ...
        return React.createElement(
          ...
          isSameMonthYear
            ? React.createElement("span", { className: "react-datepicker__month-year-option--selected" }, "\u2713")
            : "",
      ...
      (_this.renderDays = function() {
        ...
        if (_this.props.showWeekNumber) {
          var onClickAction = _this.props.onWeekSelect
            ? _this.handleWeekClick.bind(_this, startOfWeek$$1, weekNumber)
            : undefined;
  ...
  function Time() {
    ...
    return (
      ...
      (_this.handleClick = function(time) {
        if (
          ((_this.props.minTime || _this.props.maxTime) && isTimeInDisabledRange(time, _this.props)) ||
          (_this.props.excludeOutOfBoundsTimes &&
            (_this.props.minDate || _this.props.maxDate) &&
            isTimeInExcludedRange(time, _this.props)) ||
          (_this.props.excludeTimes && isTimeDisabled(time, _this.props.excludeTimes)) ||
          (_this.props.includeTimes && !isTimeDisabled(time, _this.props.includeTimes))
        ) {
          return;
        }
      ...
      (_this.liClasses = function(time, currH, currM) {
        ...
        if (
          ...
          (!_this.props.excludeOutOfBoundsTimes ? true : !isTimeInExcludedRange(time, _this.props))
        ) {
      ...
      (_this.renderTimes = function() {
        ...
        var base = getStartOfDay(activeTime);
...
var Calendar = (function(_React$Component) {
  ...
  function Calendar(props) {
    ...
    _this.header = function() {
      ...
      return dayNames.concat(
        [0, 1, 2, 3, 4, 5, 6].map(function(offset) {
          ...
          return React.createElement("div", { key: offset, className: "react-datepicker__day-name" }, weekDayName);
        }),
      );
    };
    ...
    _this.renderPreviousButton = function() {
      ...
      if (
        (!_this.props.forceShowMonthNavigation && !_this.props.showDisabledMonthNavigation && allPrevDaysDisabled) ||
    ...
    _this.renderNextButton = function() {
      ...
      if (
        (!_this.props.forceShowMonthNavigation && !_this.props.showDisabledMonthNavigation && allNextDaysDisabled) ||
        _this.props.showTimeSelectOnly
      ) {
        return;
      }
    ...
    _this.renderDefaultHeader = function(_ref) {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          {
            className:
              "react-datepicker__header__dropdown react-datepicker__header__dropdown--" + _this.props.dropdownMode,
        ...
        monthList.push(
          React.createElement(
            ...
            !_this.props.showMonthYearPicker
              ...
              : _this.renderYearHeader({ monthDate: monthDate, i: i }),
    ...
    _this.renderTimeSection = function() {
      if (_this.props.showTimeSelect && (_this.state.monthContainer || _this.props.showTimeSelectOnly)) {
        return React.createElement(Time, {
          ...
          excludeOutOfBoundsTimes: _this.props.excludeOutOfBoundsTimes,
        });
      }
    };
  ...
  function DatePicker(props) {
    ...
    _this.renderDateInput = function() {
      ...
      var className = classnames(
        ...
        ((_classnames = {}), (_classnames[outsideClickIgnoreClass] = _this.state.open), _classnames),
      );
    ...
    if (this.props.withPortal) {
      return React.createElement(
        ...
        this.state.open || this.props.inline
          ? React.createElement("div", { className: "react-datepicker__portal" }, calendar)
          : null,
      );
    }
